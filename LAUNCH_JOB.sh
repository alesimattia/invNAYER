#!/bin/bash
 ...
 #SBATCH --error=myJob_contr05_newaug.err            # standard error file
 #SBATCH --output=myJob_contr05_newaug.log           # standard output file
...
python3 datafree_kd.py --workers 4 --gpu 0 --batch_size 512 --synthesis_batch_size 400 --lr 0.2 --warmup 20 \
 ...
 --save_dir run/c10r34r18-nayer-inv-tvL1_0-tvL2_0.0001-rFeature_0.05-l2_0.00001-adi_0 --adv 1.33 --bn 10.0 --oh 0.5 --contr 0 --g_steps 30 --g_life 10 \
