...
#SBATCH --error=err/Compar_bestStud-scratch.err            # standard error file
#SBATCH --output=log/Compar_bestStud-scratch.log           # standard output file
...
python3 datafree_kd.py --workers 4 --gpu 0 --batch_size 512 --synthesis_batch_size 400 --lr 0.2 --warmup 20 \
 ...
 --PCA 3 --savedStudent best_c10r34r18-tvL2-0.0005__l2-0.00001 --distance --TSNE