...
#SBATCH --error=err/ERR_c10r34r18-DEFAULT_deepInv_tvL2-0.0001__l2-0.00001_new3.err            # standard error file
#SBATCH --output=log/LOG_c10r34r18-DEFAULT_deepInv__tvL2-0.0001__l2-0.00001_new3.log           # standard output file
...
python3 datafree_kd.py --workers 4 --gpu 0 --batch_size 512 --synthesis_batch_size 400 --lr 0.2 --warmup 20 \
 ...
 --contr 0 --log_tag c10r34r18-DEFAULT_deepInv_tvL2-0.0001__l2-0.00001_new3 \
