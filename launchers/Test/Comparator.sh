...
#SBATCH --error=err/Comparator.err            # standard error file
#SBATCH --output=log/Comparator.log           # standard output file
...
python3 datafree_kd.py --workers 4 --gpu 0 --batch_size 512 --synthesis_batch_size 400 --lr 0.2 --warmup 20 \
 ...
 --contr 0 --log_tag Comparator --seed 32 \
 --nayer_student c10r34r18-tvL2-0.0002__l2-0.00001 \
 --scratch_student cifar10_resnet18_100ep \
 --KD_student KD_student_alpha02 \
 --footprint
 #Calcola tutte le metriche non specificando --metrics
