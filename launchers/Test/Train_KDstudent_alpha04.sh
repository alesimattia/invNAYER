...
#SBATCH --error=err/ERR_KD_student_alpha04.err            # standard error file
#SBATCH --output=log/LOG_KD_student_alpha04.log           # standard output file
...
python3 datafree_kd.py --workers 4 --gpu 0 --batch_size 512 --synthesis_batch_size 400 --lr 0.2 --warmup 20 \
 ...
 --contr 0 --log_tag KD_student_alpha04 --seed 32 --tv_l2 0.0005 \
