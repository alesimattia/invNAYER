...
#SBATCH --error=err/ERR_c10r34r18-tvL2-0.0002__l2-1.err            # standard error file
#SBATCH --output=log/LOG_c10r34r18-tvL2-0.0002__l2-1.log           # standard output file
...
python3 datafree_kd.py --workers 4 --gpu 0 --batch_size 512 --synthesis_batch_size 400 --lr 0.2 --warmup 20 \
 ...
 --contr 0 --log_tag c10r34r18-tvL2-0.0002__l2-1 \
