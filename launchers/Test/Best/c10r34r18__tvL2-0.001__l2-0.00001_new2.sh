...
#SBATCH --error=err/ERR_c10r34r18-tvL2-0.001__l2-0.00001_new2.err            # standard error file
#SBATCH --output=log/LOG_c10r34r18-tvL2-0.001__l2-0.00001_new2.log           # standard output file
