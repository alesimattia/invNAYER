...
#SBATCH --error=err/Test_distance.err            # standard error file
#SBATCH --output=log/Test_distance.log           # standard output file
...
python3 datafree_kd.py --workers 4 --gpu 0 --batch_size 512 --synthesis_batch_size 400 --lr 0.2 --warmup 20 \
 ...
 --contr 0 --log_tag Test_distance --tv_l2 0  --l2 0 --seed 32 \
