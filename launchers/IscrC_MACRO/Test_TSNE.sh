...
#SBATCH --error=err/Test_TSNE.err            # standard error file
#SBATCH --output=log/Test_TSNE.log           # standard output file
...
python3 datafree_kd.py --workers 4 --gpu 0 --batch_size 512 --synthesis_batch_size 400 --lr 0.2 --warmup 20 \
 ...
 --contr 0 --log_tag Test_TSNE --tv_l2 0  --l2 0 --seed 32 \
 --savedStudent best_c10r34r18-tvL2-0.0005__l2-0.00001 --TSNE --distance